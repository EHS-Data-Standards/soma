...
slot captures the biological model, and `follows_protocols` captures domain-specific protocol details.
...
- ImagingProtocol details: frame rate, duration, and temperature
